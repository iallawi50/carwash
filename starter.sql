...
CREATE TABLE `carwash`.`reservations` (`id` INT NOT NULL AUTO_INCREMENT , `date` DATE NOT NULL , `time` TIME NOT NULL , `status` INT NOT NULL , `service_id` INT NOT NULL,  `wash_id` INT NOT NULL , `user_id` INT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
